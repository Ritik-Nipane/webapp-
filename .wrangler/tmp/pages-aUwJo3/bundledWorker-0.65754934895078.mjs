...
var Ne = /* @__PURE__ */ __name((e, t, s) => t.has(e) || Fe("Cannot " + s), "Ne");
var a = /* @__PURE__ */ __name((e, t, s) => (Ne(e, t, "read from private field"), s ? s.call(e) : t.get(e)), "a");
...
var f = /* @__PURE__ */ __name((e, t, s, i) => (Ne(e, t, "write to private field"), i ? i.call(e, s) : t.set(e, s), s), "f");
var g = /* @__PURE__ */ __name((e, t, s) => (Ne(e, t, "access private method"), s), "g");
var Le = /* @__PURE__ */ __name((e, t, s, i) => ({ set _(r) {
  f(e, t, r, s);
}, get _() {
  return a(e, t, i);
} }), "Le");
var Ue = /* @__PURE__ */ __name((e, t, s) => (i, r) => {
  let n = -1;
  return o(0);
  async function o(l) {
...
var At = /* @__PURE__ */ __name((e) => De(e, decodeURI), "At");
...
var Ie = /* @__PURE__ */ __name((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? De(e, st) : e) : e, "Ie");
var tt = /* @__PURE__ */ __name((e, t, s) => {
  let i;
  if (!s && t && !/[%+]/.test(t)) {
    let o = e.indexOf("?", 8);
...
var ze = /* @__PURE__ */ __name((e) => De(e, st), "ze");
var ne;
var S;
var $;
var rt;
...
var it = (Ke = class {
...
}, ne = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakSet(), rt = /* @__PURE__ */ __name(function(e) {
  const t = a(this, S)[0][this.routeIndex][1][e], s = g(this, $, Me).call(this, t);
  return s && /\%/.test(s) ? ze(s) : s;
}, "rt"), nt = /* @__PURE__ */ __name(function() {
  ...
  return e;
}, "nt"), Me = /* @__PURE__ */ __name(function(e) {
  return a(this, S)[1] ? a(this, S)[1][e] : e;
}, "Me"), U = /* @__PURE__ */ new WeakMap(), Ke);
var _t = { Stringify: 1 };
var at = /* @__PURE__ */ __name(async (e, t, s, i, r) => {
...
var _e = /* @__PURE__ */ __name((e, t) => ({ "Content-Type": e, ...t }), "_e");
var ge;
var me;
var _;
var ae;
...
var Dt = (Ge = class {
  ...
  constructor(e, t) {
    ...
    p(this, "html", (e2, t2, s) => {
      const i = /* @__PURE__ */ __name((r) => g(this, z, ie).call(this, r, t2, _e("text/html; charset=UTF-8", s)), "i");
...
var Ut = (le = class {
  ...
  route(t, s) {
    ...
    return s.routes.map((r) => {
      var o;
      let n;
      s.errorHandler === We ? n = r.handler : (n = /* @__PURE__ */ __name(async (l, d) => (await Ue([], s.errorHandler)(l, () => r.handler(l, d))).res, "n"), n[Ft] = r.handler), g(o = i, x, G).call(o, r.method, r.path, n);
    }), this;
  }
  basePath(t) {
  ...
  mount(t, s, i) {
    let r, n;
    i && (typeof i == "function" ? n = i : (n = i.optionHandler, i.replaceRequest === false ? r = /* @__PURE__ */ __name((d) => d, "r") : r = i.replaceRequest));
    const o = n ? (d) => {
      const c = n(d);
...
}, C = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakSet(), lt = /* @__PURE__ */ __name(function() {
...
}, "lt"), k = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ __name(function(t, s, i) {
...
}, "G"), Te = /* @__PURE__ */ __name(function(t, s) {
  if (t instanceof Error) return this.errorHandler(t, s);
  throw t;
}, "Te"), je = /* @__PURE__ */ __name(function(t, s, i, r) {
...
var dt = [];
function zt(e, t) {
  const s = this.buildAllMatchers(), i = /* @__PURE__ */ __name(((r, n) => {
...
}, W = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), Ae = /* @__PURE__ */ new WeakSet(), ut = /* @__PURE__ */ __name(function(e) {
  const t = [];
  let s = e === b;
...
}, K = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakSet(), V = /* @__PURE__ */ __name(function(t, s, i, r) {
  const n = [];
...
var cs = /* @__PURE__ */ __name((e) => async function(s, i) {
  return as({ ...e, getContent: /* @__PURE__ */ __name(async (n) => os(n, { manifest: e.manifest, namespace: e.namespace ? e.namespace : s.env ? s.env.__STATIC_CONTENT : void 0 }), "getContent") })(s, i);
}, "cs");
...
// ../.wrangler/tmp/bundle-IaHbW2/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-IaHbW2/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.65754934895078.mjs.map
